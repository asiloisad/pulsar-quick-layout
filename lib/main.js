  ...
  activate() {
    ...
    this.subscriptions.add(
      atom.commands.add("atom-workspace", {
        "quick-layout:one-pane": (e) => ensurePanes(1, true, e.detail?.redistribute),
        "quick-layout:two-columns": (e) => ensurePanes(2, true, e.detail?.redistribute),
        "quick-layout:three-columns": (e) => ensurePanes(3, true, e.detail?.redistribute),
        "quick-layout:four-columns": (e) => ensurePanes(4, true, e.detail?.redistribute),
        "quick-layout:two-rows": (e) => ensurePanes(2, false, e.detail?.redistribute),
        "quick-layout:three-rows": (e) => ensurePanes(3, false, e.detail?.redistribute),
        "quick-layout:grid": (e) => ensureGrid(e.detail?.redistribute),
