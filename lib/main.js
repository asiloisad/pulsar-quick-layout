...
module.exports = {
  ...
  addDockButtons() {
    ...
    dockGroup.classList.add("quick-layout-dock-toggles");
    DOCK_BUTTONS.forEach(({ icon, title, command }) => {
      dockGroup.appendChild(createButton(icon, title, command));
    });
  ...
  addLayoutButtons() {
    ...
    layoutGroup.classList.add("quick-layout-layouts");
    LAYOUT_BUTTONS.forEach(({ icon, title, command }) => {
      layoutGroup.appendChild(createButton(icon, title, command));
    });
...
function createButton(icon, title, command) {
...
const DOCK_BUTTONS = [
  { icon: ICONS.left, title: "Toggle Left Dock", command: "quick-layout:toggle-left-dock" },
  { icon: ICONS.bottom, title: "Toggle Bottom Dock", command: "quick-layout:toggle-bottom-dock" },
  { icon: ICONS.right, title: "Toggle Right Dock", command: "quick-layout:toggle-right-dock" },
];

const LAYOUT_BUTTONS = [
  { icon: ICONS.onepane, title: "1 Pane Layout", command: "quick-layout:one-pane" },
  { icon: ICONS.twocols, title: "2 Columns Layout", command: "quick-layout:two-columns" },
  { icon: ICONS.threecols, title: "3 Columns Layout", command: "quick-layout:three-columns" },
  { icon: ICONS.grid, title: "Grid Layout", command: "quick-layout:grid" },
];
