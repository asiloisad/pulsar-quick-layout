...
module.exports = {
  ...
  addDockButtons() {
    ...
    DOCK_BUTTONS.forEach(({ icon, iconOpen, command }, i) => {
      const dock = docks[i];
...
const DOCK_BUTTONS = [
  { icon: ICONS.left, iconOpen: ICONS.leftOpen, command: "quick-layout:toggle-left-dock" },
  { icon: ICONS.bottom, iconOpen: ICONS.bottomOpen, command: "quick-layout:toggle-bottom-dock" },
  { icon: ICONS.right, iconOpen: ICONS.rightOpen, command: "quick-layout:toggle-right-dock" },
];
